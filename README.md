...
flowchart TD
    ...
    M --> N["Decrypt Ciphertext to recover Plaintext"]
     ...
     F:::encryption
     G:::encryption
    classDef encryption fill:#DDF,stroke:#333,stroke-width:1.5px,stroke-dasharray: 5 5
    classDef decryption fill:#FDD,stroke:#333,stroke-width:1.5px,stroke-dasharray: 5 5
